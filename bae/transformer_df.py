...
class DFSingleTransformerBlock(nn.Module):
    r"""
...
@maybe_allow_in_graph
class DFTransformerBlock(nn.Module):
    r"""
    A Transformer block following the MMDiT architecture, introduced in Stable Diffusion 3.
...
class DFTransformer2DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    """
